...
public class Organization {
    ...
    public String toString() {
        return "Organization [" + "organizationId=" + organizationId + ", name=" + name + ", email="
                + email + ", phone=" + phone + ", additionalProperties=" + additionalProperties
                + "]";
    }
    ...
    public static class Builder {
        ...
        public Organization build() {
            Organization model =
                    new Organization(organizationId, name, email, phone);
