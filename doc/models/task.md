...
| `Assignee` | [`TaskAssignee`](../../doc/models/containers/task-assignee.md) | Optional | This is a container for one-of cases. | TaskAssignee getAssignee() | setAssignee(TaskAssignee assignee) |
